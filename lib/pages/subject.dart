...
class _subjectState extends State<subject> {
  ...
  bool mark;
  String classs = ' Class', status = "Select Status";
                ...
                child: Padding(
                  ...
                  child: Card(
                    margin: new EdgeInsets.symmetric(
                        ...
                        vertical: 14.5 * SizeConfig.heightMultiplier),
                              ...
                              new RaisedButton(
                                onPressed: () async {
                                  ...
                                  if (classs == " Class" ||
                                    ...
                                    prefs.setBool("callerpage", true);
                                    _subject = _controller.text.toUpperCase();
                                    if (prefs.getString("dept") == "FE") {
                                      await Alert1.selectdept(context);
                                      _subject = _subject + Dateinfo.dept;
                                      print(Dateinfo.dept);
                                    }
                                    Map exist;
                                    await dbref
...
//                                print(Dateinfo.dept+"in");
                                      ...
                                      if (!(exist
                                          .containsKey(Dateinfo.teachname))) {
                                        await dbref
                                            .child("Attendance")
                                            .child(Dateinfo.dept)
                                            .child(classs)
